...
class _$SignupStateImpl extends _SignupState {
  ...
  @override
  String toString() {
    return 'SignupState(username: $username, email: $email, password: $password, status: $status, failure: $failure)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, username, email, password, status, failure);
